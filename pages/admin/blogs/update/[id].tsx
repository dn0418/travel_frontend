...
const UpdateHotel: NextPageWithLayout<InferGetStaticPropsType<typeof getStaticProps>> = (props) => {
  ...
  const [inputData, setInputData] = useState<HotelInputType>({
    ...
    fromAirport: hotelDetails?.fromAirport || '',
    fromAirport_ru: hotelDetails?.fromAirport_ru || '',
    fromAirport_hy: hotelDetails?.fromAirport_hy || '',
    ...
    freeCancellation_ru: hotelDetails?.freeCancellation_ru || '',
    freeCancellation_hy: hotelDetails?.freeCancellation_hy || '',
    score: hotelDetails?.score || 0,
