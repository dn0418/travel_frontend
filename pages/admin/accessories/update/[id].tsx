...
const UpdateAccessory: NextPageWithLayout<InferGetStaticPropsType<typeof getStaticProps>> = (props) => {
  ...
  const [inputData, setInputData] = useState<AccessoriesInputType>({
    ...
    freeCancellation: accessory?.freeCancellation || '',
    freeCancellation_ru: accessory?.freeCancellation_ru || "",
    freeCancellation_hy: accessory?.freeCancellation_hy || "",
    score: accessory?.score || 0,
