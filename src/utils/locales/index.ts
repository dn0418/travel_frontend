...
export const localizationData: LocaleDataType = {
  en: {
    ...
    tour_page_text: "Tour Page",
    room_text: "Room",
    hotel_page_text: "Hotel Page",
  ...
  ru: {
    ...
    tour_page_text: "страница тура",
    room_text: "room",
    hotel_page_text: "страница отеля",
  ...
  hy: {
    ...
    tour_page_text: "շրջագայության էջ",
    room_text: "սենյակ",
    hotel_page_text: "հյուրանոցի էջ",
    quantity_text: "քանակ",
