    ...
    <div className="w-full my-8">
      ...
      <div hidden={currentTab.value !== 'en'}>
        <div className="mx-5 lg:mx-12 grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="col-span-2 w-full">
            <p className="font-medium uppercase">Event Description</p>
            <SunTextEditor
          ...
          <div className="col-span-2 w-full">
            <p className="font-medium uppercase">Event Images</p>
            <div
      ...
      <div className="mt-5" hidden={currentTab.value !== 'ru'}>
        <div className="mx-5 lg:mx-12 grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <TextField
            label='Language(ru)'
            onChange={(e: any) => handleInputChange('language_ru', e.target.value)}
            variant='outlined'
            className="w-full"
            value={inputData.language_ru}
          />
          <TextField
            label='Entrance(ru)'
          ...
          />
          <div className="col-span-2 w-full">
            <p className="font-medium uppercase">Event Description(ru)</p>
            <SunTextEditor
      ...
      <div className="mt-5" hidden={currentTab.value !== 'hy'}>
        <div className="mx-5 lg:mx-12 grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <TextField
            label='Language(hy)'
            onChange={(e: any) => handleInputChange('language_hy', e.target.value)}
            variant='outlined'
            className="w-full"
            value={inputData.language_hy}
          />
          <TextField
            label='Entrance(hy)'
          ...
          />
          <div className="col-span-2 w-full">
            <p className="font-medium uppercase">Event Description(hy)</p>
            <SunTextEditor
...
export default UpdateAdminEvent;