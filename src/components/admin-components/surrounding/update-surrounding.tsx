...
function UpdateAdminSurrounding({
  currentTab,
  handleImageChange,
  inputData,
  handleRemoveImage,
  ...
  return (
    <div className="w-full my-8">
      <div className="w-full flex flex-col items-center gap-4">
        ...
        <SectionTitle title="Update To Do in Surrounding" />
      </div>
      <div hidden={currentTab.value !== 'en'}>
        ...
        <div className="flex mx-5 lg:mx-12 justify-start mt-8">
          <Button
            ...
            className="py-3"
            variant="contained">
            {isLoading ? "Updating..." : "Update To Do in Surrounding"}
          </Button>
        </div>
      </div>
...
export default UpdateAdminSurrounding;