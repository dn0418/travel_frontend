...
function AccessoryThumbnailSection({ accessoryDetails }: { accessoryDetails: TourAccessoryType }) {
  const { thumbnail, images } = accessoryDetails;
...
export default AccessoryThumbnailSection;