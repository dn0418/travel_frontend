      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-5">
        ...
        <div className="px-4 md:px-12">
          <h3 className="text-[#000000] text-xl font-semibold mt-0">
            {
              locale === "ru" ? car.name_ru : (locale === "hy" ? car.name_hy : car.name)
            }
          </h3>
          {car.totalReview > 0 && <p className="flex items-center gap-2">
            ...
            <span className="text-sm text-[#5e5e5e]">
              {car.rating.toFixed(1) + ' ' + localData.star_text
                + ' | ' + car.totalReview + ' ' + localData.people_text}
            </span>
          </p>}
          ...
          <p className="flex items-center gap-2 text-base text-[#5e5e5e]">
            ...
            <span>
              {car.freeCancellation ? localData.transportData.yes_text
          ...
          <p className="flex items-center gap-2 text-base text-[#5e5e5e]">
            ...
            <span>
              {
                locale === 'ru' ? car.pickup_ru :
                  (locale === 'hy' ? car.pickup_hy : car.pickup)
              }
            </span>
          </p>
          <p className="flex items-center gap-2 text-base text-[#5e5e5e]">
            ...
            <span>
              {
                locale === 'ru' ? car.fuel_ru :
                  (locale === 'hy' ? car.fuel_hy : car.fuel)
              }
            </span>
          </p>
          <p className="flex items-center gap-2 text-base text-[#5e5e5e]">
